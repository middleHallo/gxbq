...
Page({
  ...
  next: function () {
    ...
    // 设置头像信息和标题信息
    wx.setStorageSync('icon', selectedImg)
    ...
    let url = config.service.requesturl + 'gxbq/createList'
    ...
    wx.uploadFile({
      ...
      success:function(res){
        ...
        // 设置
        wx.setStorageSync('minicodeurl', data.minicode)
        setTimeout(function(){
          //跳转
          wx.navigateTo({
            url: '/pages/createshare/createshare',
          })
        },1000)
      }
    })
